...
export function NavBar({ items, className }: NavBarProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 bg-white/60 border border-black/10 backdrop-blur-lg py-1 px-1 rounded-full shadow-sm">
        {items.map((item) => {
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                "text-black/60 hover:text-blue-500",
                isActive && "bg-black/5 text-blue-500",
              )}
            >
