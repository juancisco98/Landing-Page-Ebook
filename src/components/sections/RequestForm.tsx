...
import { Mail, User, CheckCircle, AlertCircle, Lightbulb } from 'lucide-react';
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tighter text-black uppercase leading-snug md:leading-[0.95] mb-6">
                        ¿TIENES UN EBOOK <span className="text-blue-500 italic">EN MENTE?</span>
                    </h2>
                    <p className="text-gray-500 font-medium leading-relaxed">
                        Si no encuentras el ebook que necesitas, cuéntanoslo. Si hay suficiente demanda, lo publicamos y te avisamos primero.
                    </p>
                </div>
                    ...
                    {status === 'success' ? (
                        <div className="flex flex-col items-center gap-4 py-8 text-center">
                            ...
                            <p className="text-gray-500 font-medium">
                                Gracias por tu sugerencia. Si hay suficiente interés, lo publicamos y eres el primero en saberlo.
                            </p>
                            <button
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                            <input type="hidden" name="tipo" value="SUGERENCIA DE NUEVO EBOOK" />
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <p className="text-[9px] text-black/30 font-medium leading-relaxed">
                                    Cada sugerencia nos ayuda a decidir qué publicar. Si hay suficiente interés, lo hacemos realidad.
                                </p>
                            </div>
                            ...
                            <p className="text-center text-[10px] text-black/30 font-black tracking-widest uppercase">
                                Sin spam · Te avisamos si lo publicamos
                            </p>
                        </form>
                    )}
                </div>
